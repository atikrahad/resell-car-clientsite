...
const Drtails = ({item}) => {
    ...
    console.log(user);
    console.log(item);
    const {car_name,price,seller_name,seller_email,seller_img,category,brand,description,img,fuel,speed,classes,_id} = item;
    return (
        <div className="flex flex-col md:flex-row md:gap-10 items-start">
            <div className="w-full md:h-full -skew-y-2">
                ...
                <button  className="btn btn-neutral">Add Cart</button>
                {
            ...
            <div className="w-full md:h-full skew-y-2 space-y-2">
                ...
                <div className="flex text-xl font-medium gap-4">
                    ...
                    <h1 className="text-3xl"><span className="font-semibold">Price</span>: {price}TK</h1>
